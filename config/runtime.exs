...
#
#     PHX_SERVER=true bin/elixir_configs_example start
#
...
config :elixir_configs_example, ElixirConfigsExampleWeb.Endpoint, secret_key_base: secret_key_base
...
#
#     config :elixir_configs_example, ElixirConfigsExample.Mailer,
